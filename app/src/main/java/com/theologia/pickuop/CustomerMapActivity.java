        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (requestBol){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Pick me up").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_pickup)));
       ...
       /* PlaceAutocompleteFragment autocompleteFragment = (PlaceAutocompleteFragment)
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(Status status) {
                ...
                //destination = "University of Peloponnese";
                //destinationLatLng = (38.224670976141084, 21.745691415958508)
